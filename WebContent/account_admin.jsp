					...
					<ul class="nav nav-sidebar">
						...
						<li><a href="#usermanagement"
							class="nav-header menu-first collapsed" data-toggle="collapse">
								<i class="fa fa-users fa-fw fa-2x"></i>&nbsp;用户管理<b
						...
						<ul id="libraryupdate" class="nav nav-list collapse menu-second">
							<li><a href="###" onclick="showAtRight('productList.jsp')"><i
									class="fa fa-pencil-square fa-fw"></i>&nbsp;写作题库</a></li>
							<li><a href="###" onclick="showAtRight('productList.jsp')"><i
									class="fa fa-microphone fa-fw"></i>&nbsp;口语题库</a></li>
							<li><a href="###" onclick="showAtRight('productList.jsp')"><i
									class="fa fa-headphones fa-fw"></i>&nbsp;听力题库</a></li>
							<li><a href="###" onclick="showAtRight('productList.jsp')"><i
									class="fa fa-file-word-o fa-fw"></i>&nbsp;单词库</a></li>
						</ul>
