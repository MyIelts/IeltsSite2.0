...
<body>
				...
				<div class="col-md-10 column">
						...
						<ul class="nav1" style="display: inline">
							...
							<li style="display: inline"><a href="###"
								onclick="showAtRight('Tasklist_wwait.jsp')"><i
									class="fa fa-envelope-square fa-fw fa-2x"></i>&nbsp;待分配的任务</a></li>
					...
					<table
						...
						<%
							...
							String sql = "select WR.RecordID,WR.UserName, PM.PaymentTime,WR.`status` from writingrecords AS WR LEFT JOIN payment PM ON WR.RecordId=PM.TaskId where WR.`status`='Unassigned'";
 ...
 %>
					...
					<a href="assignTasks"><button type="submit"
							class="btn btn-primary" style="height: 40px; width: 220px;"
							id="triggerBtn">分配任务</button></a>
				</div>
				<!-- /.main-container -->
			</div>
		</div>
